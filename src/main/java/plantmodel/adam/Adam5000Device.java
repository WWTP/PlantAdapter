...
public class Adam5000Device extends Device {
	...
	private static AnalogueEndpointInterface getEndpointInterface(Class<? extends Quantity> q){
		...
		return new AnalogueEndpointInterface(q, unit, min, max, transformation);
	}
	...
	private synchronized static Endpoint[] setupEndpoints(int HWNetworkAddress) {
		...
		endpoints.add(new Endpoint("RS232", new AnalogueEndpointInterface(javax.measure.quantity.DataAmount.class, javax.measure.quantity.DataAmount.UNIT, null, null, null)));
