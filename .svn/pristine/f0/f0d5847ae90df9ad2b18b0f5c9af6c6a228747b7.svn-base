...
public class DT80InputRecognizer implements ISink<byte[]> {
	 ...
	 * Alcuni codici noti:
	 * <ul>
	 * <li><code>0049</code></li>: dati immediati (legacy series 1)
	 ...
	 * <li><code>0072</code></li>: record di dato contenenti i risultati di una schedule.
	...
	private static boolean allowedCode(ASCIIString input) {
		...
		switch (code) 
		{
			...
			case 72: return true; // dati schedules (da manuale)
			case 151: return true; // dati schedules (legacy serie 1 - verificare)
