...
public class DeviceCommandGenerationController {
	...
	// Metodo pubblico utilizzato da chiunque abbia la necessità di accorpare
	...
	// Nota: siccome i primi comandi possono essere "adattati", è possibile che
	// in ingresso a questo metodo arrivino già dei comandi adattati.
